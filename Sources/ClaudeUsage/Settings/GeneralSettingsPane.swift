...
struct GeneralSettingsPane: View {
    ...
    /// for and the keychain item it falls back to (read-only, access token
    /// only, promptless through /usr/bin/security).
    private func credentialLine(for profile: Profile) -> String? {
