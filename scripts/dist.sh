...
# AgentUsage.app the dev loop launches. This zip is what `publish.sh` hands
...
cp "$ROOT/.build/apple/Products/Release/AgentUsage" "$APP/Contents/MacOS/AgentUsage"
